...
public class TestRome2Rio extends MyTestCase {
	...
	public void testAddNodesAndEdges() {
		...
		graph.addEdge("L3", "L2", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 100L, 3L, 3.0));
		graph.addEdge("L2", "L1", new EdgeType(rome2rio.quotes.BUSQuote.getInstance(), 1000L, 4L, 4.0));
		graph.addEdge("L2", "L3", new EdgeType(rome2rio.quotes.TRAINQuote.getInstance(), 10000L, 5L, 5.0));
		...
		graph.addEdgeType("L1", "L2", new EdgeType(rome2rio.quotes.FERRYQuote.getInstance(), 1L, 1L, 1.0));
		assertEqual(2L, graph.findEdge("L1", "L2").edgeType.size());
		graph.addEdgeType("L1", "L2", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 1L, 1L, 1.0));
		assertEqual(3L, graph.findEdge("L1", "L2").edgeType.size());
		graph.addEdgeType("L1", "L2", new EdgeType(rome2rio.quotes.BUSQuote.getInstance(), 1L, 1L, 1.0));
		assertEqual(4L, graph.findEdge("L1", "L2").edgeType.size());
		graph.addEdgeType("L1", "L2", new EdgeType(rome2rio.quotes.TRAINQuote.getInstance(), 1L, 1L, 1.0));
	...
	public Graph makeGraph() {
		...
		graph.addEdge("L1", "L2", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 10L, 123L, 23.0));
		graph.addEdge("L2", "L1", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 10L, 234L, 12.0));
		graph.addEdge("L2", "L5", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 20L, 134L, 55.0));
		graph.addEdge("L5", "L2", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 20L, 215L, 123.0));
		graph.addEdge("L2", "L4", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 15L, 234L, 67.0));
		graph.addEdge("L4", "L2", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 15L, 642L, 88.0));
		graph.addEdge("L2", "L3", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 14L, 2134L, 234.0));
		graph.addEdge("L3", "L2", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 13L, 1531L, 1003.0));
		graph.addEdge("L5", "L6", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 60L, 451L, 114.0));
		graph.addEdge("L6", "L7", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 55L, 462L, 665.0));
		graph.addEdge("L6", "L8", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 22L, 134L, 54.0));
		graph.addEdge("L8", "L6", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 51L, 231L, 245.5));
		graph.addEdge("L7", "L3", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 100L, 141L, 123.0));
		graph.addEdge("L5", "L9", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 4L, 512L, 134.0));
		graph.addEdge("L9", "L5", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 90L, 141L, 131.0));
		graph.addEdge("L9", "L10", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 30L, 352L, 7000.0));
		graph.addEdge("L10", "L9", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 120L, 42L, 64.0));
		graph.addEdge("L10", "L12", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 62L, 875L, 5000.0));
		graph.addEdge("L12", "L10", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 78L, 232L, 56.0));
		graph.addEdge("L12", "L11", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 788L, 162L, 6888L));
		graph.addEdge("L11", "L12", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 700L, 124L, 6444L));
		graph.addEdge("L11", "L9", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 33L, 456L, 95.0));
		graph.addEdge("L9", "L11", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 33L, 567L, 74.0));
		graph.addEdge("L11", "L13", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 9L, 891L, 41.0));
		graph.addEdge("L13", "L11", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 10L, 921L, 92.0));
		graph.addEdge("L13", "L16", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 87L, 120L, 22.0));
		graph.addEdge("L16", "L13", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 86L, 519L, 15.0));
		graph.addEdge("L16", "L15", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 50L, 140L, 12.0));
		graph.addEdge("L15", "L16", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 55L, 501L, 93.0));
		graph.addEdge("L15", "L13", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 23L, 124L, 54.0));
		graph.addEdge("L13", "L15", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 22L, 901L, 246.0));
		graph.addEdge("L13", "L14", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 17L, 120L, 234.0));
		graph.addEdge("L14", "L13", new EdgeType(rome2rio.quotes.CARQuote.getInstance(), 15L, 190L, 421.0));
		graph.addEdgeType("L1", "L2", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 15L, 190L, 421.0));
		graph.addEdgeType("L2", "L5", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 15L, 190L, 421.0));
		graph.addEdgeType("L5", "L9", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 15L, 190L, 421.0));
		graph.addEdgeType("L9", "L10", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 12L, 190L, 421.0));
		graph.addEdgeType("L10", "L12", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 13L, 190L, 421.0));
		graph.addEdgeType("L12", "L11", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 14L, 190L, 421.0));
		graph.addEdgeType("L9", "L11", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 78L, 190L, 56.0));
		graph.addEdgeType("L11", "L13", new EdgeType(rome2rio.quotes.PLANEQuote.getInstance(), 15L, 190L, 421.0));
		return graph;
	}
	...
	public void testDijkstraCar() {
		...
		Path path = null;
		path = graph.findPath("L1", "L15", rome2rio.quotes.TIMEQuote.getInstance(),
		...
		path = graph.findPath("L9", "L3", rome2rio.quotes.TIMEQuote.getInstance(),
				rome2rio.quotes.CARQuote.getInstance());
		...
		path = graph.findPath("L1", "L1", rome2rio.quotes.TIMEQuote.getInstance(),
				rome2rio.quotes.CARQuote.getInstance());
		assertEqual(0L, path.cost);
		assertEqual(1L, path.path.size());
		assertEqual("L1", ((Node) Utils.get(path.path, 1L)).location);
		path = graph.findPath("L1", "L15", rome2rio.quotes.PRICEQuote.getInstance(),
				rome2rio.quotes.CARQuote.getInstance());
		...
		path = graph.findPath("L15", "L7", rome2rio.quotes.DISTANCEQuote.getInstance(),
				rome2rio.quotes.CARQuote.getInstance());
	...
	public void testDijkstraPlane() {
		...
		Graph graph = makeGraph();
		Path path = null;
		path = graph.findPath("L1", "L13", rome2rio.quotes.TIMEQuote.getInstance(),
		...
		path = graph.findPath("L1", "L13", rome2rio.quotes.PRICEQuote.getInstance(),
				rome2rio.quotes.PLANEQuote.getInstance());
		...
		assertEqual("L11", ((Node) Utils.get(path.path, 5L)).location);
		assertEqual("L13", ((Node) Utils.get(path.path, 6L)).location);
		path = graph.findPath("L5", "L13", rome2rio.quotes.DISTANCEQuote.getInstance(),
				rome2rio.quotes.PLANEQuote.getInstance());
	...
	public void testAddTravelTypes() {
		...
		r2r.addNewTransportationType("L1", "L2", rome2rio.quotes.PLANEQuote.getInstance(), 50L, 50L, 50.5);
		assertEqual(2L, r2r.graph.findEdge("L1", "L2").edgeType.size());
		r2r.addNewTransportationType("L1", "L2", rome2rio.quotes.FERRYQuote.getInstance(), 30L, 30L, 30.5);
		assertEqual(3L, r2r.graph.findEdge("L1", "L2").edgeType.size());
		r2r.addNewTransportationType("L2", "L3", rome2rio.quotes.PLANEQuote.getInstance(), 50L, 50L, 50.5);
	...
	public void testGetRouteWithCriteria() {
		...
		Path path = null;
		r2r.graph = makeGraph();
		path = r2r.getRouteWithCriteria("L1", "L15", rome2rio.quotes.CARQuote.getInstance(),
		...
		assertEqual("L13", ((Node) Utils.get(path.path, 6L)).location);
		assertEqual("L15", ((Node) Utils.get(path.path, 7L)).location);
		path = r2r.getRouteWithCriteria("L1", "L15", rome2rio.quotes.PLANEQuote.getInstance(),
				rome2rio.quotes.TIMEQuote.getInstance());
