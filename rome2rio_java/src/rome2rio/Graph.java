...
public class Graph {
  ...
  public Path findPath(
    ...
    while (whileCond_1) {
...

      {
        ...
        if (Utils.equals(currentNode.location, target)) {
          ...
          for (Iterator iterator_13 = currentNode.outwardEdges.iterator();
              iterator_13.hasNext();
              ) {
            Edge outwardEdge = (Edge) iterator_13.next();
            for (Iterator iterator_14 = outwardEdge.edgeType.iterator(); iterator_14.hasNext(); ) {
              EdgeType type = (EdgeType) iterator_14.next();
              Number weight = 0L;
              ...
              if (Utils.equals(type.travelType, travelType)) {
                ...
                orResult_1 = Utils.equals(travelType, rome2rio.quotes.ANYQuote.getInstance());
              }
    ...
    if (Utils.equals(foundTarget, true)) {
      ...
      return new Path(((Object) travelType), ((Object) criterion));
    }
  }
  ...
  public Path getPathSourceToTarget(
    ...
    Path path = new Path(((Object) type), ((Object) criterion));
